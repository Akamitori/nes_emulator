...
mod ldy_tests {
    ...
    fn test_0xb4_ldy_zero_page_x() {
        ...
        cpu.load_and_run(vec![test_helper::increase_x_by_one(), 0xb4, mem_to_load as u8 - 1, 0x00]);
    ...
    fn test_0xbc_ldy_absolute_x() {
        ...
        cpu.load_and_run(vec![test_helper::increase_x_by_one(), 0xbc, mem_bytes[0], mem_bytes[1], 0x00]);
