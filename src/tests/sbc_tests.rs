...
fn test_0xe9_sbc_immediate() {
    ...
    let prep = test_helper::set_register_a_to_value(accum_value);
...
//     let set_low_bytes_of_minuend_to_accumulator = test_helper::set_register_a_to_value(minuend_bytes[0]);
//     let store_low_bytes_minuend_from_accum_to_memory=test_helper::store_register_to_address_zero_page(0);
//     let set_high_bytes_of_minuend_to_accumulator = test_helper::set_register_a_to_value(minuend_bytes[1]);
//     let store_high_bytes_minuend_from_accum_to_memory=test_helper::store_register_to_address_zero_page(1);

//     let subtrahend_store_memory=2;
//     let set_low_bytes_of_subtrahend_to_accumulator = test_helper::set_register_a_to_value(subtrahend_bytes[0]);
//     let store_low_bytes_subtrahend_from_accum_to_memory=test_helper::store_register_to_address_zero_page(subtrahend_store_memory);
//     let set_high_bytes_of_subtrahend_to_accumulator = test_helper::set_register_a_to_value(subtrahend_bytes[1]);
//     let store_high_bytes_subtrahend_from_accum_to_memory=test_helper::store_register_to_address_zero_page(subtrahend_store_memory+1);

//     let store_high_bytes_of_result_to_memory=test_helper::store_register_to_address_zero_page(5);
//     let store_low_bytes_of_result_to_memory=test_helper::store_register_to_address_zero_page(4);
...
//         test_helper::pull_stack_into_accumulator(), 
