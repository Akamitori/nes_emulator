...
mod ldx_tests {
    ...
    fn test_0xb6_ldx_zero_page_y() {
        ...
        cpu.load_and_run(vec![test_helper::increase_y_by_one(), 0xb6, mem_to_load as u8 - 1, 0x00]);
    ...
    fn test_0xbe_ldx_absolute_y() {
        ...
        cpu.load_and_run(vec![test_helper::increase_y_by_one(), 0xbe, mem_bytes[0], mem_bytes[1], 0x00]);
