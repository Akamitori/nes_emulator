...
fn test_0x29_and_immediate_and() {
    ...
    let prep = test_helper::set_register_a_to_value(0x32);
...
fn test_0x29_and_negative_flag() {
    ...
    let prep = test_helper::set_register_a_to_value(0xF1);
...
fn test_0x35_and_zero_page_x() {
    ...
    let prep = test_helper::set_register_a_to_value(0x11);
...
fn test_0x2d_and_absolute() {
    ...
    let prep = test_helper::set_register_a_to_value(0x19);
...
fn test_0x2d_and_zero_flag() {
    ...
    let prep = test_helper::set_register_a_to_value(0x02);
    cpu.load_and_run(vec![prep[0], prep[1], 0x2d, 0x00, 0x10, 0x00]);
...
fn test_0x3d_and_absolute_x() {
    ...
    let prep = test_helper::set_register_a_to_value(0x01);
    cpu.load_and_run(vec![
        prep[0],
        prep[1],
        test_helper::increase_x_by_one(),
...
fn test_0x39_and_absolute_y() {
    ...
    let prep = test_helper::set_register_a_to_value(0x91);
    cpu.load_and_run(vec![
        prep[0],
        prep[1],
...
fn test_0x21_and_indirect_x() {
    ...
    let prep = test_helper::set_register_a_to_value(0x90);
    cpu.load_and_run(vec![
        prep[0],
        prep[1],
        test_helper::increase_x_by_one(),
...
fn test_0x31_and_indirect_y() {
    ...
    let prep = test_helper::set_register_a_to_value(0x6);
    cpu.load_and_run(vec![
        prep[0],
        prep[1],
        test_helper::increase_y_by_one(),
