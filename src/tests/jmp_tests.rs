...
fn test_0x6c_jmp_indirect_page_boundary() {
    ...
    let set_a_to_initial_value = test_helper::set_register_a_to_value(accum_initial_value);
    let set_a_to_final_value = test_helper::set_register_a_to_value(accum_final_value);
    let set_a_to_a_wrong_value = test_helper::set_register_a_to_value(0);
